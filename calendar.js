(() => {
  ...
  const events = [
    ...
    {
      id: 'july-boundaries-practice',
      title: 'Границы специалиста в помогающей практике',
      category: 'Воркшоп',
      date: new Date(2026, 6, 3, 18, 30),
      endTime: '20:30',
      format: 'Онлайн',
      speaker: 'Екатерина Свердловская',
      speakerRole: 'психолог',
      description: 'Практическая встреча о том, как выдерживать контакт с клиентом и сохранять профессиональные границы без жесткости',
      location: 'Онлайн-группа',
      seatsLeft: 9
    },
    {
      id: 'july-supervision-dialogue',
      title: 'Супервизия: трудные моменты в диалоге',
      category: 'Супервизия',
      date: new Date(2026, 6, 9, 18, 0),
      endTime: '20:00',
      format: 'Онлайн',
      speaker: 'Наталья Строк',
      speakerRole: 'психотерапевт',
      description: 'Разберем случаи, где контакт останавливается, появляется сопротивление или специалисту сложно выбрать следующий шаг',
      location: 'Zoom, малая группа',
      seatsLeft: 6
    },
    {
      id: 'july-ethics-note',
      title: 'Профессиональная этика и ясный контракт',
      category: 'Лекция',
      date: new Date(2026, 6, 15, 19, 0),
      endTime: '20:30',
      format: 'Онлайн',
      speaker: 'Анна Воронина',
      speakerRole: 'психолог, арт-терапевт',
      description: 'Лекция о договоренностях, ответственности специалиста и способах обсуждать сложные организационные вопросы с клиентом',
      location: 'Онлайн-трансляция'
    },
    {
      id: 'july-group-process',
      title: 'Групповой процесс: как замечать динамику',
      category: 'Вебинар',
      ...
      speaker: 'Дмитрий Соколов',
      speakerRole: 'психотерапевт',
      description: 'Поговорим о ролях, напряжении и способах поддерживать группу так, чтобы процесс оставался живым и безопасным',
      location: 'Москва + онлайн',
      seatsLeft: 11
    },
    {
      id: 'july-community-conference',
      title: 'Летняя встреча профессионального сообщества',
      category: 'Конференция',
      date: new Date(2026, 6, 30, 12, 0),
      endTime: '18:00',
      format: 'Очно',
      speaker: 'Команда Le Collectif',
      speakerRole: 'практикующие специалисты и авторы',
      description: 'День коротких выступлений, открытых дискуссий и знакомства специалистов, которые развивают профессиональную среду',
      location: 'Санкт-Петербург, пространство Le Collectif',
      seatsLeft: 18
    }
  ];
